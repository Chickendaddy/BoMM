...
public class Step2_two extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new SampleItem("코미디,전쟁 혹은 SF 영화 등 인터넷으로 다운받아 보기"));
		adapter.add(new SampleItem("인터넷 서핑하거나 인기있는 웹툰 보기"));
		...
		adapter.add(new SampleItem("내가 생각하는 긍적적인 말들로 가득 채운 일기 써보기"));
		adapter.add(new SampleItem("미래 나의 모습을 상상해보면서 긍적적인 부분들을 구체적으로 끄적여 보기"));
		adapter.add(new SampleItem("화나는 생각을 큰 소리로 욕하면서 적고 찢어버리기"));
