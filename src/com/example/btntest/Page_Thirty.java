...
public class Page_Thirty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//btn_next = (ImageButton) findViewById(R.id.thirty_nextBtn);
		//btn_prev = (ImageButton) findViewById(R.id.thirty_prevBtn);
		
		thirty_nextBtn = (Button)findViewById(R.id.thirty_nextBtn);
...
/*
		btn_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Globals.getInstance().setPersonName(thirty_personName1.getText().toString(),
						thirty_personName2.getText().toString(), thirty_personName3.getText().toString());
				Globals.getInstance().setPersonNumber(thirty_personNumber1.getText().toString(),
						thirty_personNumber2.getText().toString(), thirty_personNumber3.getText().toString());
	...
	private void DialogSimple2() {
		...
		alt_bld.setMessage("누구와 할지 다시한번 곰곰히 생각해봐~").setCancelable(false).setPositiveButton("OK",
	...
	private void DialogSimple() {
		...
		AlertDialog.Builder alt_bld = new AlertDialog.Builder(this);
		alt_bld.setMessage("무엇을 할지 꼭! 작성해 보자!").setCancelable(false).setPositiveButton("OK",
				new DialogInterface.OnClickListener() {
	...
	*/
	 ...
	 * Cursor cursor = null;
	 * 
	 * Uri uri = ContactsContract.CommonDataKinds.Phone.CONTENT_URI; String
	 * phoneName = ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME;
	 * 
	 ...
	 * if(0 == list.size()){
	 * 
	 * bean = new AddrBean(); bean.setName(cursor.getString(0));
	 * bean.setNumber(cursor.getString(1)); beanList.add(bean); }else{
	 * 
	 * if(!beanList.get(beanList.size()-1).getNumber().equals(cursor.getString(1
	 * ))){
	 * 
	 * bean = new AddrBean(); bean.setName(cursor.getString(0));
	 * bean.setNumber(cursor.getString(1)); beanList.add(bean);
	 * 
	 * }
	 * 
	 * }
