...
public class Page_Twenty_Two extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		twenty_tow_nextBtn = (Button)findViewById(R.id.twenty_tow_nextBtn);
