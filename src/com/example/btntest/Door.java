	...
	public static class PageFragment extends Fragment implements View.OnClickListener {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			if(0 == mPageNumber){
				...
				textView.setText("이렇게 힘들고 복잡한 상황에서\n\n _________친구에게 해 줄 수 있는 말은 단 한가지.\n\n\n\n");
				...
				textView.setText("_________친구가 힘든 상황에 부딪혀\n\n우울이나 무기력감 등의 부정적인 기분이\n\n죽고 싶다는 생각으로 이어질 때,");			
				...
				textView1.setText("_________친구 마음속의 부정적인 감정이나\n\n생각의 브레이크로 잘 작동하기 위해서는\n\n_________친구의 도움이 필요합니다.");
				textView2.setText("\n어렵지 않습니다");
				...
				textView1.setText("'내 마음의 브레이크,봄' 어플리케이션에서\n\n제시하는 단계에 따라 생각해보면서\n\n자유롭게 적어보면 됩니다.\n\n망설이지 말고, 일단 시작해볼까요?");
		...
		public void onClick(View v) {
			...
			case R.id.fifteenBtn :
				...
				//Toast toast = Toast.makeText(mContext, "haha", Toast.LENGTH_SHORT);
				//toast.show();
				getActivity().finish();
				break;
