...
public class Page_Thirty_Five extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		thirty_five_nextBtn = (Button)findViewById(R.id.thirty_five_nextBtn);
		...
		thirty_five_txt2.setText("그들 역시 " + name + " 친구와 함께 이 위기를 극복하도록 저극적으로 도와줄 것입니다." + name + " 친구는 충분히 도움 받을 자격이 있습니다."
		...
		thirty_five_nextBtn.setOnClickListener(new OnClickListener() {
